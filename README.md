...
📖 **Full documentation:** Download and open [`docs.html`](docs.html) in your browser for the complete reference — installation, all flags, tuning guide, API, FAQ, and more.
