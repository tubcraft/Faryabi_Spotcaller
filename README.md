...
This pipeline builds on the following open-source tools — please cite them if you use this software in your research:

**Piscis** — deep learning spot detection
> Niu Z, O'Farrell A, Li J, Reffsin S, Jain N, Dardani I, Goyal Y, & Raj A. (2025).
...
> Nature Methods. https://doi.org/10.1038/s41592-022-01663-4

**SpotCaller** — the classical adaptive spot detector (`spot_caller.py`) was implemented with the assistance of [Claude](https://claude.ai) (Anthropic), based on standard Laplacian-of-Gaussian methodology.
...
The underlying tools (Piscis, Cellpose) have their own licenses (MIT and BSD respectively) which also apply to their respective components.
